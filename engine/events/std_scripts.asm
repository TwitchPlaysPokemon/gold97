...
;	setevent EVENT_ILEX_FOREST_FARFETCHD
	...
	setevent EVENT_RIVAL_TEAM_ROCKET_BASE; used to make sui disappear
;	setevent EVENT_BLACKTHORN_CITY_SUPER_NERD_DOES_NOT_BLOCK_GYM
;	setevent EVENT_USED_THE_CARD_KEY_IN_THE_RADIO_TOWER
	setevent EVENT_RIVAL_CHERRYGROVE_CITY
	setevent EVENT_RIVAL_AZALEA_TOWN; used to make en disappear
	setevent EVENT_RIVAL_GOLDENROD_UNDERGROUND
	setevent EVENT_AZALEA_TOWN_SLOWPOKES; used to make rai disappear
	...
	setevent EVENT_WHIRL_ISLAND_JUBILEY_CHAMBER_JUBILEY
...
;	setevent EVENT_FAST_SHIP_CABINS_SE_SSE_CAPTAINS_CABIN_TWIN_1
	...
	setevent EVENT_FLORIA_AT_BELLIGNAN
...
;	setevent EVENT_TIN_TOWER_1F_WISE_TRIO_2
	...
	setevent EVENT_SAW_SUI_ON_ROUTE_36
	setevent EVENT_SAW_SUI_ON_ROUTE_42
	setevent EVENT_SAW_SUI_AT_CIANWOOD_CITY
	setevent EVENT_BATTLE_TOWER_OUTSIDE_SAILOR
	setflag ENGINE_ROCKET_SIGNAL_ON_CH20
	setflag ENGINE_ROCKETS_IN_MAHOGANY
	variablesprite SPRITE_WEIRD_TREE, SPRITE_BELLIGNAN

...
JubileyFrontpic:       INCBIN "gfx/pokemon/jubiley/front.animated.2bpp.lz"
...
BruinusFrontpic:  INCBIN "gfx/pokemon/bruinus/front.animated.2bpp.lz"
...
TearorFrontpic:      INCBIN "gfx/pokemon/tearor/front.animated.2bpp.lz"
...
HitmonbaFrontpic:   INCBIN "gfx/pokemon/hitmonba/front.animated.2bpp.lz"
...
BaririnaFrontpic:      INCBIN "gfx/pokemon/baririna/front.animated.2bpp.lz"
...
PoliranaFrontpic:    INCBIN "gfx/pokemon/polirana/front.animated.2bpp.lz"
...
HigedoraFrontpic:     INCBIN "gfx/pokemon/higedora/front.animated.2bpp.lz"
...
TuheddFrontpic:      INCBIN "gfx/pokemon/tuhedd/front.animated.2bpp.lz"
BootbootFrontpic:     INCBIN "gfx/pokemon/bootboot/front.animated.2bpp.lz"
...
WatanekoFrontpic:    INCBIN "gfx/pokemon/wataneko/front.animated.2bpp.lz"
...
KirinirikFrontpic:   INCBIN "gfx/pokemon/kirinirik/front.animated.2bpp.lz"
DrowzeeFrontpic:     INCBIN "gfx/pokemon/drowzee/front.animated.2bpp.lz"
BitachiFrontpic:     INCBIN "gfx/pokemon/bitachi/front.animated.2bpp.lz"
...
MagikrowFrontpic:     INCBIN "gfx/pokemon/magikrow/front.animated.2bpp.lz"
...
OctotankFrontpic:   INCBIN "gfx/pokemon/octotank/front.animated.2bpp.lz"
...
PengiftFrontpic:    INCBIN "gfx/pokemon/pengift/front.animated.2bpp.lz"
...
MagbratFrontpic:       INCBIN "gfx/pokemon/magbrat/front.animated.2bpp.lz"
...
DonpongonFrontpic:    INCBIN "gfx/pokemon/donpongon/front.animated.2bpp.lz"
...
BegongerFrontpic:     INCBIN "gfx/pokemon/begonger/front.animated.2bpp.lz"
PoponekoFrontpic:    INCBIN "gfx/pokemon/poponeko/front.animated.2bpp.lz"
...
PrimatailFrontpic:       INCBIN "gfx/pokemon/primatail/front.animated.2bpp.lz"
...
BesitoFrontpic:    INCBIN "gfx/pokemon/besito/front.animated.2bpp.lz"
...
CleffeyFrontpic:      INCBIN "gfx/pokemon/cleffey/front.animated.2bpp.lz"
...
PlucksFrontpic:    INCBIN "gfx/pokemon/plucks/front.animated.2bpp.lz"
...
HanekoFrontpic:      INCBIN "gfx/pokemon/haneko/front.animated.2bpp.lz"
...
PichunkFrontpic:       INCBIN "gfx/pokemon/pichunk/front.animated.2bpp.lz"

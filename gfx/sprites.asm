...
BellignanSpriteGFX::           INCBIN "gfx/sprites/bellignan.2bpp"
...
SuiSpriteGFX::             INCBIN "gfx/sprites/sui.2bpp"
EnSpriteGFX::               INCBIN "gfx/sprites/en.2bpp"
RaiSpriteGFX::              INCBIN "gfx/sprites/rai.2bpp"

...
; Johto story events
	...
	const EVENT_GOT_CUBBURN_FROM_ELM
	const EVENT_GOT_PALSSIO_FROM_ELM
	...
	const EVENT_FOUGHT_BELLIGNAN ;used, for pryce in his house
	...
	const EVENT_060
	const EVENT_GOT_BEGONGER_FROM_KIYO
...
; Johto itemballs
	const EVENT_CUBBURN_POKEBALL_IN_ELMS_LAB
	const EVENT_PALSSIO_POKEBALL_IN_ELMS_LAB
...
; Johto people
	...
	const EVENT_RIVAL_AZALEA_TOWN; en event
	const EVENT_RIVAL_TEAM_ROCKET_BASE; sui event
	...
	const EVENT_AZALEA_TOWN_SLOWPOKES; rai event
	...
	const EVENT_WHIRL_ISLAND_JUBILEY_CHAMBER_JUBILEY
	...
	const EVENT_FLORIA_AT_BELLIGNAN
...
; New to Crystal
	...
	const EVENT_SAW_SUI_AT_CIANWOOD_CITY
	const EVENT_SAW_SUI_ON_ROUTE_42
	const EVENT_SAW_SUI_ON_ROUTE_36 ; 7b0
	const EVENT_6F2
	const EVENT_6F3
	const EVENT_TIN_TOWER_1F_EN; used for getting starter from scientist
	const EVENT_6F4
	const EVENT_6F5
	const EVENT_6F6

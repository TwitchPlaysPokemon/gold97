...
; entries correspond to SPRITE_* constants
	...
	overworld_sprite BellignanSpriteGFX, 4, STILL_SPRITE, PAL_OW_BROWN
	...
	overworld_sprite SuiSpriteGFX, 4, STILL_SPRITE, PAL_OW_BLUE
	overworld_sprite EnSpriteGFX, 4, STILL_SPRITE, PAL_OW_RED
	overworld_sprite RaiSpriteGFX, 4, STILL_SPRITE, PAL_OW_RED

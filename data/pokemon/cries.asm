...
; entries correspond to constants/pokemon_constants.asm
	...
	mon_cry CRY_PALSSIO,      $2f0,  $0a0 ; FLAMBEAR
	mon_cry CRY_PALSSIO,      $de0,  $1a0 ; BRUINUS
	mon_cry CRY_RAYLEEP,     $f90,  $090 ; PALSSIO
	mon_cry CRY_GOLEM,       $300,  $0f0 ; PRESSIO
	mon_cry CRY_PALSSIO,     -$010,  $0c0 ; DONMARIN
	mon_cry CRY_MARILL,      $f4c,  $110 ; BURGELA
	mon_cry CRY_GOLEM,      -$010,  $1a0 ; JUNGELA
	mon_cry CRY_HOOTHOOT,    $091,  $0d8 ; HOOTHOOT
	mon_cry CRY_HOOTHOOT,    $000,  $1a0 ; BOOTBOOT
	mon_cry CRY_LEDYBA,      $000,  $0de ; LEDYBA
	mon_cry CRY_LEDYBA,     -$096,  $138 ; TRIPSTAR
	mon_cry CRY_SPINARAK,    $011,  $200 ; SPINARAK
	mon_cry CRY_SPINARAK,   -$0ae,  $1e2 ; TUHEDD
	mon_cry CRY_SQUIRTLE,   -$010,  $140 ; CROBAT
	mon_cry CRY_PICHUNK,       $f60,  $200 ; KOTORA
	mon_cry CRY_RAI,      $db3,  $168 ; RAITORA
	mon_cry CRY_PICHUNK,       $000,  $140 ; PICHUNK
	mon_cry CRY_CLEFFEY,      $061,  $091 ; CLEFFEY
	mon_cry CRY_CHIKORITA,   $0e8,  $0e8 ; IGGLYBUFF
	mon_cry CRY_TOGEPI,      $010,  $100 ; TOGEPI
	mon_cry CRY_MARILL,      $0c0,  $090 ; KOLTA
	...
	mon_cry CRY_CLEFFEY,      $084,  $150 ; BELLOSSOM
	mon_cry CRY_MARILL,      $11b,  $120 ; MARILL
	mon_cry CRY_PALSSIO,      $e90,  $160 ; GRENMAR
	mon_cry CRY_CATERPIE,    $06d,  $160 ; BELLIGNAN
	mon_cry CRY_CLEFFEY,     -$2a3,  $1c8 ; POLIRANA
	mon_cry CRY_CLEFFEY,      $03b,  $0c8 ; HANEKO
	mon_cry CRY_CLEFFEY,      $027,  $138 ; POPONEKO
	mon_cry CRY_CLEFFEY,      $000,  $180 ; WATANEKO
	mon_cry CRY_PRIMATAIL,      -$051,  $0e8 ; PRIMATAIL
	mon_cry CRY_SPEAROW,     $0a0,  $050 ; ORFRY
	...
	mon_cry CRY_PRIMATAIL,       $0a2,  $140 ; ESPEON
	mon_cry CRY_VENONAT,    -$0e9,  $0f0 ; UMBREON
	mon_cry CRY_MARILL,     -$01f,  $180 ; MAGIKROW
	mon_cry CRY_SLOWKING,    $104,  $200 ; SLOWKING
	mon_cry CRY_LAPRAS,      $0B0,  $0D0 ; VULPIII
	mon_cry CRY_HOOTHOOT,    $162,  $100 ; UNOWN
	mon_cry CRY_KIRINIRIK,   $06b,  $144 ; BIPULLA
	mon_cry CRY_KIRINIRIK,   $041,  $200 ; KIRINIRIK
	mon_cry CRY_MADAME,      $2f1,  $140 ; DISTURBAN
	mon_cry CRY_GRIMER,      $080,  $0b0 ; SMUJJ
	...
	mon_cry CRY_RAICHU,      $123,  $100 ; PLUCKS
	mon_cry CRY_AMPHAROS,    $000,  $160 ; TEAROR
	mon_cry CRY_MIMMEO,       $040,  $100 ; MOIBELLE
	mon_cry CRY_MIMMEO,       $020,  $300 ; BELLEDAM
	mon_cry CRY_ANGORE,   $053,  $0af ; BITACHI
	mon_cry CRY_SLOWKING,    $160,  $0e0 ; QWILFISH
	mon_cry CRY_SLOWKING,    $fce,  $160 ; KAZAPPELIN
	mon_cry CRY_MARILL,      $0f4,  $0c0 ; COINPUR
	mon_cry CRY_SPEAROW,     $02d,  $0a0 ; MADAME
	mon_cry CRY_GRIMER,      $210,  $100 ; STROMEN
	mon_cry CRY_GRIMER,      $9a0,  $190 ; PHANDARIN
	mon_cry CRY_GROWLITHE,   $0a1,  $0e8 ; PUPPERON
	mon_cry CRY_SUNFLORA,    $00d,  $100 ; REMORAID
	mon_cry CRY_PALSSIO,      $000,  $180 ; OCTOTANK
	mon_cry CRY_QWILFISH,    $002,  $06a ; PENGIFT
	mon_cry CRY_RAYLEEP,    -$0be,  $0f0 ; RAYLEEP
	mon_cry CRY_AMPHAROS,    $8a9,  $180 ; SKARMORY
	mon_cry CRY_CUBBURN,    $039,  $140 ; HOUNDOUR
	mon_cry CRY_PALSSIO,     -$10a,  $100 ; HOUNDOOM
	mon_cry CRY_COINPUR,      $2fb,  $100 ; HIGEDORA
	mon_cry CRY_BURGELA,        $048,  $230 ; PHANPY
	mon_cry CRY_DONPHAN,     $000,  $1a0 ; DONPHAN
	mon_cry CRY_KIRINIRIK,   $073,  $240 ; DONPONGON
	mon_cry CRY_KOLTA,    $730,  $068 ; BARIRINA
	mon_cry CRY_PICHUNK,      -$21a,  $1f0 ; SMEARGLE
	mon_cry CRY_PRIMATAIL,       $02c,  $108 ; BEGONGER
	mon_cry CRY_COINPUR,      $000,  $100 ; HITMONBA
	mon_cry CRY_MARILL,      $068,  $100 ; BESITO
	mon_cry CRY_SUNFLORA,   -$2d8,  $0b4 ; ELEBABE
	mon_cry CRY_QWILFISH,    $176,  $03a ; MAGBRAT
	mon_cry CRY_SEEL,        $9fa,  $0b0 ; DODAERIE actually dodaerie
	mon_cry CRY_MIMMEO,      -$1cd,  $1a0 ; MILTANK
	mon_cry CRY_RAI,      $22e,  $120 ; RAI
	mon_cry CRY_EN,       $000,  $1a0 ; EN
	mon_cry CRY_MADAME,      $000,  $180 ; SUI
	mon_cry CRY_RAI,     -$0b0,  $120 ; WARFURS
	mon_cry CRY_RAI,     -$1db,  $150 ; WEARLYCAN
	mon_cry CRY_SEEL,       -$100,  $180 ; LICKILORD
	mon_cry CRY_SLOWKING,    $293,  $140 ; JUBILEY actually miltank
	mon_cry CRY_BRUINUS,       0,   256 ; LUGIA
	mon_cry CRY_PRIMATAIL,       $000,  $180 ; HO_OH
	mon_cry CRY_PRIMATAIL,       $0d2,  $100 ; LEAFEON
	mon_cry CRY_MARILL,       182,   384 ; AMARILLE

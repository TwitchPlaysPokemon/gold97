...
PoliwhirlEvosAttacks:
	...
	db EVOLVE_ITEM, HEART_STONE, POLIRANA
	db 0 ; no more evolutions
	db 1, BUBBLE
	db 1, HYPNOSIS
	db 7, HYPNOSIS
...
ChanseyEvosAttacks:
	db EVOLVE_HAPPINESS, TR_ANYTIME, JUBILEY
	db 0 ; no more evolutions
	db 1, POUND
	db 4, GROWL
	db 7, TAIL_WHIP
...
SeadraEvosAttacks:
	db EVOLVE_ITEM, DRAGON_SCALE, HIGEDORA
	db EVOLVE_TRADE, DRAGON_SCALE, HIGEDORA
HigedoraEvosAttacks:
	db 0 ; no more evolutions
    db 1, BUBBLE
	db 1, LEER
...
DittoEvosAttacks:
	db EVOLVE_ITEM, METAL_COAT, MIMMEO
...
PorygonEvosAttacks:
	db EVOLVE_ITEM, UP_GRADE, DONPONGON
	db EVOLVE_TRADE, UP_GRADE, DONPONGON
	db 0 ; no more evolutions
	db 1, TACKLE
	db 1, SHARPEN
	db 1, CONVERSION
...
MarillEvosAttacks:
	db EVOLVE_ITEM, HEART_STONE, AMARILLE
	db 0 ; no more evolutions
	db 1, TACKLE
	db 1, TAIL_WHIP
	db 6, WATER_GUN
...
BegongerEvosAttacks:
	...
	db EVOLVE_STAT, 20, ATK_EQ_DEF, HITMONBA
	db 0 ; no more evolutions
	db 1, TACKLE
	db 0 ; no more level-up moves

...
FalknerGroup:
	...
	db  62, BOOTBOOT, GOLD_BERRY, HYPNOSIS, REFLECT, DREAM_EATER, SKY_ATTACK
...
WhitneyGroup:
	...
	db 60, JUBILEY, NO_ITEM, SOFTBOILED, LIGHT_SCREEN, SING, MINIMIZE
...
BugsyGroup:
	...
	db 63, TUHEDD, SILVERPOWDER,   PIN_MISSILE, PSYCHIC_M, SLUDGE_BOMB, SPIDER_WEB
	...
	db 62, TEAROR, SCOPE_LENS,  SLASH, FURY_CUTTER, SWORDS_DANCE, DOUBLE_TEAM
	db 62, PARASECT, MIRACLE_SEED, SPORE, GIGA_DRAIN, GROWTH, FURY_CUTTER
	db 64, PLUCKS, SCOPE_LENS, METAL_CLAW, SUBMISSION, MEGAHORN, FOCUS_ENERGY
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_MOVES; used
	db 22, STROMEN,     PSYWAVE, CURSE, CONFUSE_RAY, MEAN_LOOK
...
PryceGroup:
	...
	db 64, PENGIFT, NEVERMELTICE, BLIZZARD, HEAL_BELL, HAZE, DRILL_PECK
	db 62, CLOYSTER, LEFTOVERS,  HYDRO_PUMP, PROTECT, SPIKES, BLIZZARD
	db 63, BITACHI, SCOPE_LENS, METAL_CLAW, ICE_PUNCH, SLASH, AGILITY
	db 64, LAPRAS, MYSTIC_WATER, SURF, ICE_BEAM, BODY_SLAM, SING
	db 67, WEARLYCAN,  NEVERMELTICE,  ICE_PUNCH, SLASH, SWAGGER, LOW_KICK
	db -1 ; end
...
OkeraGroup:
	...
	db 38, MAGIKROW,  WING_ATTACK, THIEF, STEEL_WING, DETECT
	db 40, KIRINIRIK,  CONFUSE_RAY, THIEF, PAIN_SPLIT, CRUNCH
	db 39, MAGIKROW,  QUICK_ATTACK, THIEF, TOXIC, HAZE
	db 42, HOUNDOOM,  FLAMETHROWER, CRUNCH, SWAGGER, SLUDGE_BOMB
	db -1 ; end

	db "OKERA@", TRAINERTYPE_ITEM_MOVES; rematch
	db 64, MAGIKROW, NO_ITEM,  DRILL_PECK, THIEF, STEEL_WING, DETECT
	db 63, KIRINIRIK, MIRACLEBERRY,  CONFUSE_RAY, PSYCHIC_M, PAIN_SPLIT, CRUNCH
	db 64, BELLEDAM, BLACKGLASSES, GLARE, DISABLE, PURSUIT, ATTRACT
	db 65, MAGIKROW, GOLD_BERRY,  PERISH_SONG, FAINT_ATTACK, TOXIC, MEAN_LOOK
	db 63, RAYLEEP, BRIGHTPOWDER, CONFUSE_RAY, HYDRO_PUMP, WING_ATTACK, PSYBEAM
...
ClairGroup:
	...
	db 70, HIGEDORA, MIRACLEBERRY, SMOKESCREEN, SURF, HYPER_BEAM, DRAGONBREATH
	db -1 ; end
...
Rival1Group:
	...
	db 20, GRENMAR,  LICK, WATER_GUN, FLAME_WHEEL, NO_MOVE
	...
	db 34, BELLEDAM,  HEADBUTT, BITE, DISABLE, SWIFT;belledam
	db 34, GRENMAR,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, NO_MOVE;grenmar
	db 35, RAITORA,    THUNDER_WAVE, THUNDERBOLT, MUD_SLAP, ENDURE;kotora
	db 36, MEGANIUM,    DOUBLE_TEAM, SLEEP_POWDER, RAZOR_LEAF, BODY_SLAM;petamole
	db -1 ; end
	...
	db 34, GRENMAR,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, NO_MOVE;grenmar
	db 35, RAITORA,    THUNDER_WAVE, THUNDERBOLT, MUD_SLAP, ENDURE;kotora
	db 36, BRUINUS,    ROAR, FLAME_WHEEL, CRUNCH, DOUBLE_TEAM
	db -1 ; end
	...
	db 34, GRENMAR,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, NO_MOVE;grenmar
	db 35, RAITORA,    THUNDER_WAVE, THUNDERBOLT, MUD_SLAP, ENDURE;kotora
	db 36, DONMARIN,   AURORA_BEAM, SAFEGUARD, SURF, IRON_TAIL
	db -1 ; end

	; RIVAL1 (13)
	db "?@", TRAINERTYPE_MOVES
	db 43, MADAME,     SWORDS_DANCE, SLASH, FLY, AGILITY;madame
	db 44, BELLEDAM,   HEADBUTT, BITE, DOUBLE_TEAM, SLASH;belledam
	db 44, GRENMAR,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, FIRE_SPIN;grenmar
	db 45, RAITORA,    THUNDER_WAVE, THUNDERBOLT, MUD_SLAP, SLASH;raitora
	db 45, PHANDARIN,     PAIN_SPLIT, SHADOW_BALL, PSYBEAM, BODY_SLAM;phandarin
	db 47, MEGANIUM,   SYNTHESIS, LEECH_SEED, RAZOR_LEAF, BODY_SLAM;meganium
	db -1 ; end
	...
	db 45, RAITORA,    THUNDER_WAVE, THUNDERBOLT, MUD_SLAP, SLASH;raitora
	db 45, PHANDARIN,     PAIN_SPLIT, SHADOW_BALL, PSYBEAM, BODY_SLAM;phandarin
	db 47, BRUINUS,   SMOKESCREEN, CRUNCH, QUICK_ATTACK, FLAMETHROWER
	db -1 ; end
	...
	db 45, RAITORA,    THUNDER_WAVE, THUNDERBOLT, MUD_SLAP, SLASH;raitora
	db 45, PHANDARIN,     PAIN_SPLIT, SHADOW_BALL, PSYBEAM, BODY_SLAM;phandarin
	db 47, DONMARIN,   IRON_TAIL, ICY_WIND, SURF, BODY_SLAM
	db -1 ; end
...
WillGroup:
	...
	db 53, WEARLYCAN,    SLASH, BLIZZARD, LOW_KICK, CONFUSE_RAY
	...
	db 64, DONMARIN, MYSTERYBERRY,  HYDRO_PUMP, ICE_BEAM, BODY_SLAM, SAFEGUARD
	db 65, WEARLYCAN, NEVERMELTICE,    SLASH, BLIZZARD, LOW_KICK, CONFUSE_RAY
...
PKMNTrainerGroup:
	...
	db 40, BRUINUS, FLAMETHROWER, CRUNCH, DOUBLE_TEAM, REST
	db 40, DONMARIN, BODY_SLAM, ICE_BEAM, HYDRO_PUMP, SAFEGUARD
...
BrunoGroup:
	...
	db 54, PHANDARIN,   PAIN_SPLIT, SHADOW_BALL, REFLECT, PERISH_SONG
	...
	db 66, PHANDARIN, SPELL_TAG,   PAIN_SPLIT, SHADOW_BALL, REFLECT, PERISH_SONG
...
KogaGroup:
	...
	db 52, TUHEDD,    DOUBLE_TEAM, PIN_MISSILE, TOXIC, PSYCHIC_M
	...
	db 64, TUHEDD, TWISTEDSPOON,   DOUBLE_TEAM, PIN_MISSILE, TOXIC, PSYCHIC_M
	...
	db 66, DISTURBAN, QUICK_CLAW, CRUNCH, HYDRO_PUMP, PROTECT, SLUDGE_BOMB
...
ScientistGroup:
	...
	db 38, DONPONGON, TRI_ATTACK, RECOVER, AGILITY, PSYBEAM
	db -1 ; end
	...
	db 40, OCTOTANK,   OCTAZOOKA, FOCUS_ENERGY, AURORA_BEAM, FLAMETHROWER
	db 42, DONPONGON,    ICE_BEAM, PSYBEAM, RECOVER, TRI_ATTACK
	db -1 ; end
...
JanineGroup:
	...
	db 62, HITMONBA, BLACKBELT,   TRIPLE_KICK, DETECT, COUNTER, PURSUIT
...
CooltrainerMGroup:
	...
	db 20, MIMMEO,  TRANSFORM, NO_MOVE, NO_MOVE, NO_MOVE
	...
	db 72, TEAROR, AGILITY, WING_ATTACK, SLASH, SWORDS_DANCE
...
CooltrainerFGroup:
	...
	db 25, POPONEKO,   SYNTHESIS, POISONPOWDER, MEGA_DRAIN, LEECH_SEED
	...
	db 47, BELLIGNAN,  SUNNY_DAY, SOLARBEAM, RAZOR_LEAF, ACID
	db -1 ; end
...
BeautyGroup:
	...
	db 18, COINPUR,     MUD_SLAP, GROWL, BITE, PAY_DAY
	...
	db 31, HANEKO,     SYNTHESIS, MEGA_DRAIN, TACKLE, POISONPOWDER
	db 32, POPONEKO,   SYNTHESIS, MEGA_DRAIN, TACKLE, STUN_SPORE
	db -1 ; end
...
SabrinaGroup:
	...
	db 36, MIMMEO,   TRANSFORM, NO_MOVE, NO_MOVE, NO_MOVE
	...
	; SABRINA (1)
	db "OAK@", TRAINERTYPE_MOVES
	db 40, MIMMEO,   TRANSFORM, NO_MOVE, NO_MOVE, NO_MOVE
...
BugCatcherGroup:
	...
	db 11, PARASPOR,	SCRATCH, STUN_SPORE, POISONPOWDER, NO_MOVE
...
FisherGroup:
	...
	db 58, OCTOTANK, ZAP_CANNON, LOCK_ON, OCTAZOOKA, ICE_BEAM
...
SuperNerdGroup:
	...
	db 52, DONPONGON, TRI_ATTACK, RECOVER, LOCK_ON, ZAP_CANNON
	db -1 ; end
	...
	db 52, DONPONGON, TRI_ATTACK, PSYBEAM, LOCK_ON, ZAP_CANNON
	db -1 ; end
...
Rival2Group:
	...
	db 54, BELLEDAM,   HEADBUTT, GLARE, MUD_SLAP, FAINT_ATTACK;belledam
	db 56, GRENMAR,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, TAKE_DOWN;grenmar
	db 54, RAITORA,    THUNDER_WAVE, THUNDERBOLT, SLASH, CRUNCH;raitora
	db 57, MEGANIUM,   SYNTHESIS, BODY_SLAM, RAZOR_LEAF, EARTHQUAKE;meganium
	db 54, PHANDARIN,     CONFUSE_RAY, PAIN_SPLIT, PSYCHIC_M, SHADOW_BALL;phandarin
	db -1 ; end
	...
	db 56, GRENMAR,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, TAKE_DOWN;grenmar
	db 54, RAITORA,    THUNDER_WAVE, THUNDERBOLT, SLASH, CRUNCH;raitora
	db 57, BRUINUS,   ROAR, EARTHQUAKE, SLASH, FLAMETHROWER
	db 54, PHANDARIN,     CONFUSE_RAY, PAIN_SPLIT, PSYCHIC_M, SHADOW_BALL;phandarin
	db -1 ; end
	...
	db 56, GRENMAR,    DOUBLE_TEAM, BUBBLEBEAM, FLAME_WHEEL, TAKE_DOWN;grenmar
	db 54, RAITORA,    THUNDER_WAVE, THUNDERBOLT, SLASH, CRUNCH;raitora
	db 57, DONMARIN,   BODY_SLAM, ICE_BEAM, SURF, EARTHQUAKE
	db 54, PHANDARIN,     CONFUSE_RAY, PAIN_SPLIT, PSYCHIC_M, SHADOW_BALL;phandarin
	db -1 ; end
...
JugglerGroup:
	...
	db 20, CLEFFEY,		 POUND, CHARM, SING, SWEET_KISS
...
BlackbeltGroup:
	...
	db 32, HITMONBA,  QUICK_ATTACK, RAPID_SPIN, DOUBLE_TEAM, AGILITY
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 28, STROMEN,   MEAN_LOOK, CONFUSE_RAY, PSYBEAM, FAINT_ATTACK
...
PsychicGroup:
	...
	db 32, DISTURBAN,     ACID, BUBBLEBEAM, ACID_ARMOR, PROTECT
	db -1 ; end
...
ExecutiveFGroup:
	...
	db 64, MAGIKROW, FOCUS_BAND, MEAN_LOOK, FAINT_ATTACK, PERISH_SONG, DRILL_PECK
...
SageGroup:
	...
	db 19, STROMEN, PSYWAVE, SPITE, FAINT_ATTACK, CURSE
	...
	db 18, STROMEN, PSYWAVE, SPITE, FAINT_ATTACK, CURSE
	db 20, STROMEN, PSYWAVE, SPITE, FAINT_ATTACK, CURSE
	db -1 ; end
...
MediumGroup:
	...
	db 21, STROMEN, PSYWAVE, SPITE, FAINT_ATTACK, CURSE
...
BlueGroup:
	...
	db 74, PLUCKS, SCOPE_LENS, METAL_CLAW, SUBMISSION, MEGAHORN, SWORDS_DANCE
...
EngineerGroup:; use super nerd sprite
	...
	db 20, PICHUNK,	THUNDERSHOCK, CHARM, SWEET_KISS, THUNDER_WAVE

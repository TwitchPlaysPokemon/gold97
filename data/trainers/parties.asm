...
BugsyGroup:
	...
	db 18, LEDIAN,     SUPERSONIC, COMET_PUNCH, LIGHT_SCREEN, MACH_PUNCH
	...
	db 63, LEDIAN, GOLD_BERRY, SUPERSONIC, REFLECT, LIGHT_SCREEN, DOUBLE_EDGE
	...
	db 64, HERACROSS, SCOPE_LENS, METAL_CLAW, SUBMISSION, MEGAHORN, FOCUS_ENERGY
	db -1 ; end
...
BlueGroup:
	...
	db 74, HERACROSS, SCOPE_LENS, METAL_CLAW, SUBMISSION, MEGAHORN, SWORDS_DANCE

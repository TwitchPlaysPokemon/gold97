...
; entries correspond to SPRITE_ANIM_INDEX_* constants
	...
	db SPRITE_ANIM_FRAMESET_INTRO_SUI,            SPRITE_ANIM_SEQ_INTRO_SUI,           $00 ; SPRITE_ANIM_INDEX_INTRO_SUI
	db SPRITE_ANIM_FRAMESET_INTRO_PICHUNK,              SPRITE_ANIM_SEQ_INTRO_PICHUNK_ANGORE,   $00 ; SPRITE_ANIM_INDEX_INTRO_PICHUNK
	db SPRITE_ANIM_FRAMESET_INTRO_ANGORE,          SPRITE_ANIM_SEQ_INTRO_PICHUNK_ANGORE,   $00 ; SPRITE_ANIM_INDEX_INTRO_ANGORE
	...
	db SPRITE_ANIM_FRAMESET_INTRO_SUI_AWAY,       SPRITE_ANIM_SEQ_INTRO_SUI_AWAY,      $00 ; SPRITE_ANIM_INDEX_INTRO_SUI_AWAY

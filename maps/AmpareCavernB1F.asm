	...
	const DARKCAVEVIOLETENTRANCE_RAI
...
RaiEvent:
	...
	loadwildmon RAI, 40
	startbattle
	disappear DARKCAVEVIOLETENTRANCE_RAI
...
AmpareCavernB1F_MapEvents:
	...
	object_event 10, 27, SPRITE_GROWLITHE, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RaiEvent, EVENT_AZALEA_TOWN_SLOWPOKES

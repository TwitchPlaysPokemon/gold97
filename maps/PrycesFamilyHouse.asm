...
PrycesFamilyHousePokefanFScript:
	...
	checkevent EVENT_FOUGHT_BELLIGNAN
...
PrycesFamilyHousePryceScript:
	...
	setevent EVENT_FOUGHT_BELLIGNAN
...
PrycesFamilyHouse_MapEvents:
	...
	object_event  7,  4, SPRITE_PRYCE, SPRITEMOVEDATA_SPINRANDOM_SLOW, 1, 1, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, PrycesFamilyHousePryceScript, EVENT_FOUGHT_BELLIGNAN
